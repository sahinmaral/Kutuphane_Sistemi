...
namespace Kutuphane_Sistemi.UI.Student_Query
{
    public partial class StudentQueryByNameSurname : Form
    {
        ...
        private void BtnScanStudent_Click(object sender, EventArgs e)
        {
            ...
            SqlDataAdapter sqlDataAdapter = new SqlDataAdapter("BRING_STUDENT_BYNAMESURNAME @STUDENTNAME='" + TxtScanStudentName.Text + "'," + "@STUDENTSURNAME='" + TxtScanStudentSurname.Text + "'", DbConnection);
            try
            {
