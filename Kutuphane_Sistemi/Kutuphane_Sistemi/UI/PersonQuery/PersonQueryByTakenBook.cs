...
{
    public partial class PersonQueryByTakenBook : Form
    {
        public PersonQueryByTakenBook()
        {
            InitializeComponent();
        }
        ...
        private void BtnScanPerson_Click(object sender, EventArgs e)
        {
            ...
            SqlDataAdapter sqlDataAdapter = new SqlDataAdapter("BRING_PERSON_BYTAKENBOOK @BOOKNAME='"+TxtScanBookName.Text+"'", DbConnection);
            try
            {
